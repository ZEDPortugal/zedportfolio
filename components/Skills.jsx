...
const Skills = ({ isLight, handleToggle }) => {
  ...
  {[
    {
      name: "HTML5",
      icon: <FaHtml5 className="w-10 h-10 mx-auto" />,
      link: "https://developer.mozilla.org/en-US/docs/Web/HTML",
    },
    {
      name: "CSS3",
      icon: <FaCss3 className="w-10 h-10 mx-auto" />,
    ...
    {
      name: "React",
      icon: <FaReact className="w-10 h-10 mx-auto" />,
      link: "https://reactjs.org/",
    },
    {
      name: "Next.js",
      icon: <RiNextjsFill className="w-10 h-10 mx-auto" />,
